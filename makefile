...
# 添加包含路径
CXXFLAGS += -I$(MYSQL_INC_PATH)
LDFLAGS += -L$(MYSQL_LIB_PATH) -lpthread -lmysqlclient

server: main.cpp  ./timer/lst_timer.cpp ./http/http_conn.cpp ./log/log.cpp ./CGImysql/sql_connection_pool.cpp ./CGImysql/sql_tool.cpp webserver.cpp config.cpp ./cookie/cookie.cpp
