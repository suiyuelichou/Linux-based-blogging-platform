...
public:
	...
	int get_message_count_by_userid_and_type(int userid, string type);	// 通过用户id和类型获取该用户收到的所有信息总数
	...
	bool update_blog_comment_username(string username, string new_username);	// 更新博客评论用户名
